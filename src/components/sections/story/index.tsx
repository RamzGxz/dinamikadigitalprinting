...
function StorySection() {
  return (
    <div className="flex items-start py-16 justify-between w-full gap-5" id="story">
      ...
      <div className="lg:w-1/2 w-full flex flex-col gap-5 items-start">
        ...
        <div className="w-full grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 gap-2">
          <div className="border w-full">
            <Image src={'/str2.jpg'} alt="" className="rounded-md" width={500} height={500} />
          </div>
          <div className="border w-full">
            <Image src={'/str1.jpg'} alt="" className="rounded-md" width={500} height={500} />
          </div>
          <div className="border w-full">
            <Image src={'/str3.jpg'} alt="" className="rounded-md" width={500} height={500} />
          </div>
          <div className="border w-full">
            <Image src={'/str5.jpg'} alt="" className="rounded-md" width={500} height={500} />
          </div>
        </div>
      </div>
    </div>
