...
const DinamikaMartSection = ({ name }: { name: string }) =>{
  return(
    <div className="w-full flex flex-col">
      <div className="w-full flex justify-between items-center lg:flex-row flex-col lg:gap-16 gap-5 h-screen">
        <div className="lg:w-1/2 w-full flex justify-center items-center">
          <Image src={'/dinamikamart.svg'} width={500} height={500} className="w-auto h-auto" alt="banner fc" />
        </div>
      ...
      <div className="flex flex-col gap-8 items-center justify-center w-full h-screen" id="galery">
